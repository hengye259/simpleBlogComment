...
public class ChannelGroup extends DefaultChannelGroup {
    ...
    private static final Logger log = LoggerFactory.getLogger(ChannelGroup.class);
    ...
    private final  ChannelFutureListener  remover      = new ChannelFutureListener() {
        ...
        public void operationComplete(ChannelFuture future) throws Exception {
           log.debug("Channel关闭前，更新BUSINESS_MAP。");
            ChannelGroup.this.removeChannelId(future.channel());
        }
    };
     ...
     * @param executor
     */
    public ChannelGroup(String groupName, EventExecutor executor) {
